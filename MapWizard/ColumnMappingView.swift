...
struct ColumnMappingTableView: NSViewRepresentable {
    @ObservedObject var erdViewModel: ERDViewModel

    private let columnLabels = ["Target Attribute", "Source", "Source Attribute",  "Score", "Preferred"]
    private let columnWidths: [CGFloat] = [150, 200, 150, 80, 50]
    let booleanColumnLabel = "Preferred"

    class Coordinator: NSObject, NSTableViewDelegate, NSTableViewDataSource {
        var parent: ColumnMappingTableView
        var erdViewModel: ERDViewModel

        init(parent: ColumnMappingTableView) {
            self.parent = parent
            erdViewModel = parent.erdViewModel
        }

        func numberOfRows(in tableView: NSTableView) -> Int {
            return erdViewModel.columnMapping.count
        }
        ...
        func tableView(_ tableView: NSTableView, viewFor tableColumn: NSTableColumn?, row: Int) -> NSView? {
            ...
            let isPreferred = erdViewModel.columnMapping[row].isSelected
        ...
        func tableView(_ tableView: NSTableView, objectValueFor tableColumn: NSTableColumn?, row: Int) -> Any? {
            let record = erdViewModel.columnMapping[row]
            let value: Any
...
struct ColumnMappingView: View {
    ...
    var body: some View {
        ColumnMappingTableView(erdViewModel: erdViewModel)
            .padding()
    }
}
...
extension Recommendation {
    static func columnMappingMock() -> [Recommendation] {
        var results = [Recommendation]()
        results.append(Recommendation(sourceName: "Source1", targetName: "Target", sourceAttribute: "Source1 Attribute 0", targetAttribute: "Target Attribute 0", score: 0.95234523))
        results.append(Recommendation(sourceName: "Source1", targetName: "Target", sourceAttribute: "Source2 Attribute 1", targetAttribute: "Target Attribute 1", score: 0.95345673457))
        results.append(Recommendation(sourceName: "Source2", targetName: "Target", sourceAttribute: "Source2 Attribute 1", targetAttribute: "Target Attribute 1", score: 0.919872456))
        results.append(Recommendation(sourceName: "Source1", targetName: "Target", sourceAttribute: "Source2 Attribute 2", targetAttribute: "Target Attribute 2", score: 0.954568))
        results.append(Recommendation(sourceName: "Source2", targetName: "Target", sourceAttribute: "Source2 Attribute 2", targetAttribute: "Target Attribute 2", score: 0.9145656))
        results.append(Recommendation(sourceName: "Source2", targetName: "Target", sourceAttribute: "A long name of a Source2 Attribute 3", targetAttribute: "A lengthy name of Target Attribute 3", score: 0.91))
        results.append(Recommendation(sourceName: "Source2", targetName: "Target", sourceAttribute: "A long name of a Source2 Attribute 3", targetAttribute: "PARTICIPANT_ID", score: 0.97))
        results.append(Recommendation(sourceName: "Source2", targetName: "Target", sourceAttribute: "A long name of a Source2 Attribute 3", targetAttribute: "PREGNANCY_TEST", score: 0.97))
...
#Preview {
    ColumnMappingView(erdViewModel: ERDViewModel.preview)
}
